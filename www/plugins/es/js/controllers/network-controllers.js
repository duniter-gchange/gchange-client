      ...
      .then(function (currency) {
        if (currency) {
          $scope.node = !esHttp.node.same(currency.node.host, currency.node.port) ?
            esHttp.instance(currency.node.host, currency.node.port, currency.node.wsPort) : esHttp;
...
function PeerInfoPopoverController($scope, $q, csSettings, csCurrency, csHttp, esHttp) {
  'ngInject';
